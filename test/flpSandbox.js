		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#dnscombrpraticamodel1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dnscombrpraticamodel1-display": {
								"semanticObject": "dnscombrpraticamodel1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dns.com.br.praticamodel1",
									"url": sap.ui.require.toUrl("dns/com/br/praticamodel1")
								}
							}
						}
					}
